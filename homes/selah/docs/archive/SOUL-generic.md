...
**If you produce no output:** the home will inject a corrective alert showing you the senders address and your undelivered output, and ask you to respond. You can always reply with `<null/>` to explicitly decline.